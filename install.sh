...
function config_dotfiles {
    ...
    rm ~/.zshrc
    rm ~/.bash_profile
    curl https://raw.githubusercontent.com/103cuong/dotfiles/main/.zshrc --output .zshrc
    curl https://raw.githubusercontent.com/103cuong/dotfiles/main/.bash_profile --output .bash_profile
    cp .zshrc ~/.zshrc
